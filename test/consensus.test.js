...
const TWO_ETHER = toWei(toBN(2), 'ether')
...
contract('Consensus', async (accounts) => {
  ...
  describe('stake (fallback function)', async () => {
    ...
    //     pendingValidators.length.should.be.equal(expectedValidators.length)
    //     pendingValidators.should.deep.equal(expectedValidators)
    //     MIN_STAKE.mul(toBN(2)).should.be.bignumber.equal(await consensus.stakeAmount(firstCandidate))
    ...
    //     pendingValidators.length.should.be.equal(expectedValidators.length)
    //     pendingValidators.should.deep.equal(expectedValidators)
    //     MIN_STAKE.mul(toBN(2)).should.be.bignumber.equal(await consensus.stakeAmount(secondCandidate))
    //   })
    // })
  })
