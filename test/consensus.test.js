  ...
  describe('stake (fallback function)', async () => {
    ...
    describe('basic', async () => {
      ...
      it('less than minimum stake - should not be added to pending validators', async () => {
        ...
        ZERO.should.be.bignumber.equal(await consensus.validatorFee(firstCandidate))
      })
      ...
      it('should allow the maximum stake', async () => {
        ...
        await consensus.sendTransaction({from: firstCandidate, value: MAX_STAKE}).should.be.fulfilled
      ...
      it('should not allow more the maximum stake', async () => {
        await consensus.sendTransaction({from: firstCandidate, value: MORE_THAN_MAX_STAKE}).should.be.rejectedWith(ERROR_MSG)
      })
    })
